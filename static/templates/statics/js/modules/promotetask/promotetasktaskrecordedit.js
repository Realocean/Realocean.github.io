...
var vm = new Vue({
    ...
    methods: {
        saveOrUpdate: function (event) {
            var url = vm.promotetaskTaskrecord.id == null ? "promotetask/promotetasktaskrecord/save" : "promotetask/promotetasktaskrecord/update";
            PageLoading();
            $.ajax({
                type: "POST",
                url: baseURL + url,
                contentType: "application/json",
                data: JSON.stringify(vm.promotetaskTaskrecord),
                success: function(r){
                    RemoveLoading();
                    if(r.code === 0){
...
function initVerify(form) {
    form.verify({
                ...
                if (vm.verify) {
                    ...
                    validate_taskobjId: function (value, item) { //value：表单的值、item：表单的DOM对象
                if (vm.verify) {
                    if (value == null || value == '') {
                        vm.verify = false;
                        return "任务id不能为空";
                ...
                if (vm.verify) {
                    ...
                    validate_taskpersonnelId: function (value, item) { //value：表单的值、item：表单的DOM对象
                if (vm.verify) {
                    if (value == null || value == '') {
                        vm.verify = false;
                        return "任务员工id不能为空";
                    ...
                    validate_customerOpenid: function (value, item) { //value：表单的值、item：表单的DOM对象
                if (vm.verify) {
                    if (value == null || value == '') {
                        vm.verify = false;
                        return "客户openid不能为空";
                ...
                if (vm.verify) {
                    ...
                    validate_customerNickName: function (value, item) { //value：表单的值、item：表单的DOM对象
                if (vm.verify) {
                    if (value == null || value == '') {
                        vm.verify = false;
                        return "昵称不能为空";
                ...
                if (vm.verify) {
                    ...
                    validate_customerAvatar: function (value, item) { //value：表单的值、item：表单的DOM对象
                if (vm.verify) {
                    if (value == null || value == '') {
                        vm.verify = false;
                        return "头像不能为空";
                ...
                if (vm.verify) {
                    if (value == null || value == '') {
                        vm.verify = false;
                        return "客户性质：1新用户 2老用户不能为空";
                    }
                }
            },
                    validate_customerPhoneModel: function (value, item) { //value：表单的值、item：表单的DOM对象
                if (vm.verify) {
                    if (value == null || value == '') {
                        vm.verify = false;
                        return "手机型号不能为空";
                    ...
                    validate_recordSnapshot: function (value, item) { //value：表单的值、item：表单的DOM对象
                if (vm.verify) {
                    if (value == null || value == '') {
                        vm.verify = false;
                        return "浏览记录详细快照不能为空";
