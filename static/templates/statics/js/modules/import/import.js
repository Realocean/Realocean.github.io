...
<div class="card-wrap flex-col">
        <span class="item-title">导入车辆订单信息</span>
        ...
        <div class="sub-wrap">
            ...
            <div class="sub-wrap-right">
                <span class="sub-title">填写导入数据信息</span>
                <span class="sub-tip">请按照数据模板的格式准备导入数据，模板中的表头名称不可更改，表头行不能删除</span>
                <div class="flex-center">
                    <span v-for="(item, index) in downLoadTemplateTypes[currentTab]"
                        @click="downloadExportTemplate(item, 1)"
                        :key="index" class="down-btn">下载{{item.label}}模版</span>
                </div>
            </div>
        </div>
        ...
        <div class="sub-wrap">
            ...
            <div class="sub-wrap-right">
                <span class="sub-title">请上传导入文件</span>
                <span class="sub-tip">文件后缀名必须为xls 或xlsx（即Excel格式），文件大小不得大于10M，最多支持导入3000条数据</span>
                <div class="flex-center">

                    <div class="right10" id="orderModel" v-if="currentTab==1" >
                    ...
                    <div class="right10" id="customerModel" v-if="currentTab==2">
                    ...
                    <span v-show="currentTab==0" class="down-btn demoMore" lay-data="{url: baseURL+'car/tcarbasic/importTwo'}">请选择上传文件</span>
                    <span v-show="currentTab==1 && orderCarShow==1" class="down-btn demoMore" lay-data="{url: baseURL+'order/order/inportsTwo'}">请选择上传文件</span>
                    <span v-show="currentTab==1 && orderCarShow==2" class="down-btn verifyForm">请选择上传文件</span>
                    <span v-show="currentTab==2 && customerShow==1" class="down-btn demoMore" lay-data="{url: baseURL+'customer/importCustomerTwo'}">请选择上传文件</span>
                    <span v-show="currentTab==2 && customerShow==2" class="down-btn verifyForm">请选择上传文件</span>
                    <span v-show="currentTab==3" class="down-btn demoMore" lay-data="{url: baseURL+'maintenance/insurancemanage/importTwo'}">请选择上传文件</span>
                    <span v-show="currentTab==4" class="down-btn demoMore" lay-data="{url: baseURL+'maintenance/inspectionmanage/importTwo'}">请选择上传文件</span>
                    <span v-show="currentTab==5" class="down-btn demoMore" lay-data="{url: baseURL+'maintenance/maintenancemanage/importExcelTwo'}">请选择上传文件</span>
                    <span v-show="currentTab==6" class="down-btn demoMore" lay-data="{url: baseURL+'outinsuranceorder/ouinsuranceorder/importExcelTwo'}">请选择上传文件</span>
                    <span v-show="currentTab==7" class="down-btn demoMore" lay-data="{url: baseURL+'carrepairorder/carrepairorder/importExcelTwo'}">请选择上传文件</span>
                    <span v-show="currentTab==8" class="down-btn demoMore" lay-data="{url: baseURL+''}">请选择上传文件</span>
        ...
        <span class="gray-bg">
            ...
            <div class="sub-wrap-right">
                <span class="sub-title info">特别提示</span>
                <span class="sub-tip">下载导入模板，根据要求填写，填写完成之后上传文件</br>
                    导入过程中如发现同名客户，则更新这条客户数据</span>
            </div>
        </span>
...
Vue.component('import-upload', {
    template: `
    <div class="card-wrap flex-col">
        <span class="item-title">导入车辆行驶证</span>
        ...
        <div class="reminder-box">
            ...
            <div class="reminder-tab">
                ...
                <div class="reminder-tip-item">
                    <img class="reminder-tip-icon" :src="filterUrl('/statics/images/import/tip3.png')" alt="">
                    <p>cl_xsz</p>
                    <p>文件夹以车辆行驶证拼音简写命名</p>
                </div>
                <div class="reminder-tip-item">
                    <img class="reminder-tip-icon" :src="filterUrl('/statics/images/import/tip4.png')" alt="">
                    <p>cl_xsz.zip</p>
                    <p>压缩包以车辆行驶证拼音简写命名</p>
                </div>
            </div>
            <div class="reminder-tip-text">
                <p class="reminder-tip">注意事项：<br>
                    ...
                    5.一次只支持上传一个压缩文件，并且压缩文件大小不能超过500M.</p>
            </div>
        </div>
