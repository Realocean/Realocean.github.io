...
var vm = new Vue({
    el: '#rrapp',
    data: {
        compulsoryEnTimeNs:null,
        commercialEnTimeNs:null,
        //交强险保险公司下拉列表数据源
            ...
            $.ajax({
                ...
                success: function(r){
                    if(r.code === 0){
                        ...
                        vm.compulsoryEnTimeNs = r.insuranceManage.compulsoryEnTime;
                        vm.commercialEnTimeNs = r.insuranceManage.commercialEnTime;
