            ...
            $.get(baseURL + "order/ordercaralteration/info/" + param.id, function (r) {
                if (r.code == 0){
                    if(_this.viewTag == 'approve'|| _this.viewTag == 'reedit'||_this.viewTag == 'edit'||_this.viewTag == 'approveDetail'||_this.viewTag == 'applyDetail'){
                        ...
                        _this.initData.margin = r.applyForDTO.margin;
    ...
    methods: {
        ...
        showBox: function (submit) {
            ...
            var index = layer.open({
                ...
                success: function(layero, index){
                    var btn1Class = "layui-layer-btn0";
                    var btn2Class = "layui-layer-btn1";
                    $('.layui-layer-btn a:eq(0)').addClass(btn2Class).removeClass(btn1Class);
                    $('.layui-layer-btn a:eq(1)').addClass(btn1Class).removeClass(btn2Class);
                },
                end: function(){
                    vm.boxShow = false;
                    vm.fileLst2=[];
        ...
        reeditAgain: function(){
            ...
            var index = layer.open({
                ...
                type: 2,
                boxParams: param,
                content: tabBaseURL + "modules/order/applycarback.html",
                end: function () {
                    layer.close(index);
                }
            });
