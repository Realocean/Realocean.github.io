$(function () {
    ...
    if (vm.settleType == 1) {
        ...
        console.log("以租代购111111",vm.applyForDTO.timeFinishRent)
        layui.laydate.render({
            elem: '#date',
            type: 'date',
            trigger: 'click',
        ...
        if(param.viewTag != 'apply'){
            ...
            if(window.localStorage.getItem("code")!='' && window.localStorage.getItem("code")!=null){
                $.get(baseURL + "order/ordercaralteration/detailData/" + window.localStorage.getItem("code"), function (r) {
                    ...
                    _this.applyForDTO.currTimeStartRent = _this.order.orderCar.currTimeStartRent == null? dateFormatYMD(_this.order.orderCar.timeStartRent):dateFormatYMD(_this.order.orderCar.currTimeStartRent);
    ...
    methods: {
        ...
        reeditAgain: function(){
            ...
            var index = layer.open({
                ...
                type: 2,
                boxParams: param,
                content: tabBaseURL + "modules/order/applyrenttransfercar.html",
                end: function () {
                    layer.close(index);
                }
            });
