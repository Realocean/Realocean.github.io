...
var vm = new Vue({
    ...
    methods: {
        chosePlan:function(data){
            Vue.set(parent.vm.scPlanConfig,'commissionId',data.commissionPlanId);
            Vue.set(parent.vm.scPlanConfig,'planName',data.planName);
