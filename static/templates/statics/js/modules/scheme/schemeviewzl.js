...
var vm = new Vue({
    el:'#rrapp',
    data:{
        detailsTabContentList: [ '租赁方案', '操作记录',],
        detailsSupTabContentListActiveValue: '租赁方案',
    ...
    methods: {
        ...
        generateQrcode:function(data){
            ...
            let thisDeptIds = data.deptIds;
            console.log("deptids:::",thisDeptIds);
        ...
        $.ajax ({
            ...
            success : function(data){
                $.ajax({
                    type: "POST",
                    async:false,
                    url: baseURL + "scheme/scheme/info/"+pid+"/"+3,
                    contentType: "application/json",
                    data: {},
                    success: function(r){
...
function initTableData(table, soulTable) {
    table.render({
        ...
        maxWidth:'100%',
        cols: [[
            {title: '操作', width:130, templet:'#barTpl',fixed:"left",align:"center"},
            {field:'deptNames', title: '所属门店',align:"center", minWidth:200, templet: function (d) {return isEmpty(d.deptNames);}},
            {field:'wxJSCodeEnable', title: '微信小程序', align:"center",minWidth:150, templet: function (d) {
            ...
            {field:'aliPayJSCodeEnable', title: '支付宝小程序',align:"center", minWidth:150, templet: function (d) {
            ...
            {field:'customerType', title: '客户类型', align:"center",minWidth:150, templet: function (d) {
            ...
            {field:'deposit', title: '保证金/元', align:"center",minWidth:150, templet: function (d) {return isEmpty(d.deposit);}},
            {field:'monthlyRent', title: '月租/元', align:"center",minWidth:150, templet: function (d) {return isEmpty(d.monthlyRent);}},
            ...
            {field:'coverCharge', title: '服务费/元',align:"center", minWidth:150, templet: function (d) {return isEmpty(d.coverCharge);}},
            {field:'chlNames', title: '所属渠道', align:"center",minWidth:200, templet: function (d) {return isEmpty(d.chlNames);}},
            {field:'chlMonthlyRent', title: '月租金渠道价/元',align:"center", minWidth:200, templet: function (d) {return isEmpty(d.chlMonthlyRent);}},
            {field:'chlRebate', title: '渠道商返利/元', align:"center",minWidth:200, templet: function (d) {return isEmpty(d.chlRebate);}},
...
function sendData(schemeEntityDTO) {
    ...
    if(vm.scheme.isPopularCarRental==0){
        $("#sortDiv").show();
    }else if(vm.scheme.isPopularCarRental==1){
        $("#sortDiv").hide();
