        ...
        $.ajax ({
            ...
            success : function(data){
                $.ajax({
                    type: "POST",
                    async:false,
                    url: baseURL + "scheme/scheme/info/"+pid+"/"+4,
                    contentType: "application/json",
                    data: {},
                    success: function(r){
...
function initTableData(table, soulTable) {
    table.render({
        ...
        cols: [[
            ...
            {field:'deptNames', title: '所属门店', minWidth:200,fixed:"left", templet: function (d) {return isEmpty(d.deptNames);}},
            ...
            {field:'downPayment', title: '首付款/元', minWidth:150, templet: function (d) {return isEmpty(d.downPayment);}},
            ...
            {field:'chlNames', title: '所属渠道', minWidth:150, templet: function (d) {return isEmpty(d.chlNames);}},
