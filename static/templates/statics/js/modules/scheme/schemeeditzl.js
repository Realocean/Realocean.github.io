                                ...
                                for (var i = 0; i <schemeList.length ; i++) {
                                    if(schemeList[i].schemeId !=vm.scheme.schemeId){
                                        ...
                                        var index = layer.open({
                                            ...
                                            area: ['90%', '85%'],
                                            boxParams: vm.scheme,
                                            content: tabBaseURL + 'modules/subscheme/subschemeeditzl.html',
                                            end: function () {
                                                layer.close(index);
                                            }
                                        });
...
function initTable(table, soulTable) {
   ...
   //   url: baseURL + 'subscheme/subscheme/list',
        ...
        cols: [[
            ...
            {field:'deposit', title: '保证金/元', minWidth:200, templet: function (d) {return isEmpty(d.deposit);}},
            {field:'monthlyRent', title: '月租/元', minWidth:200, templet: function (d) {return isEmpty(d.monthlyRent);}},
            ...
            {field:'coverCharge', title: '服务费/元', minWidth:200, templet: function (d) {return isEmpty(d.coverCharge);}},
            ...
            {field:'isEnable', title: '是否启用', minWidth:200, templet: function (d) {
                    if(d.isEnable==1){
                        return "启用";
