...
var vm = new Vue({
    ...
    methods: {
        ...
        view: function (warningId) {
            $.get(baseURL + "car/carwarning/info/" + warningId, function(r){
                var param = {
                ...
                var index = layer.open({
                    ...
                    type: 2,
                    boxParams: param,
                    content: tabBaseURL + "modules/car/carwarningview.html",
                    end: function () {
                        layer.close(index);
                    }
                });
        ...
        exports: function () {
            var url = baseURL + 'car/carwarning/export?a=a';
            if(vm.q.deptId != null){
...
function initTable(table, soulTable) {
    ...
    //  defaultToolbar: ['filter'],
        ...
        url: baseURL + "car/carwarning/queryList",
        cols: [[
            ...
            {field : 'electricName', minWidth : 200, title : '电子围栏名称',templet:function (d) {
                    return isEmpty(d.electricName);
             }},
            {field : 'warningType', minWidth : 200, title : '报警类型', templet : function(d) {
                    //报警类型（1.驶入报警 2.驶出报警）
                    if (d.warningType == 1) {
                        return "驶入报警"
            ...
            {field : 'warningTime', minWidth : 200, title : '报警时间',templet:function (d) {
