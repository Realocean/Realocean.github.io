...
var vm = new Vue({
    ...
    data: {
        ...
        financeTabContentList: ['应收', '应付', '应退'],
        financeTabContentListActiveIndex: 0,
        financeTabContentListActiveValue: '应收',
        // tCarBasic:{},
        accessoryList:[],
        carCountDto:{},
        illegalData:[],
    ...
    methods: {
        gotoPage(item){
            ...
            if(item.name==='基础信息'){
                ...
                //     businessType:vm.tCarBasic.businessType
                // };
                // let url=tabBaseURL+item.url;
                // addTab(url,item.title,param);
                var index = layer.open({
                    ...
                    success: function (layero, num) {
                        ...
                        iframe.vm.initEditData(vm.tCarBasic.carId);
            ...
            if(item.name==='换牌记录'){
                var param =data;
                var  vehicleCar = {}
                param.brandModel = data.carBrandSeriesModelName;
                param.imgDrivinglicenseFront1 = data.imgDrivinglicenseFront;
                if (data.imgDrivinglicenseFront != null && data.imgDrivinglicenseFront != '') {
                    param.imgDrivinglicenseFront = imageURL + data.imgDrivinglicenseFront;
                    vehicleCar = {
                    ...
                    param.imgDrivinglicenseFront = '../../statics/images/upload@2x.png';
                }
                let url=tabBaseURL+item.url;
                addTab(url,item.title,{param:param,vehicleCar:vehicleCar});
            }
            if(item.name==='处置记录'){
                var businessType = data.businessType;
                var ifChuZhi = data.ifChuZhi;
                if((businessType ==1||businessType ==2) && ifChuZhi==1){
                    var carDisposal = {
                        carNo: data.carNo,
                        vinNo: data.vinNo,
                    ...
                    var url = tabBaseURL+item.url;
                    addTab(url,item.title,carDisposal);
                }else{
                    alert('只有备发车和整备中的车辆才可处置')
                }
        ...
        noiceMove(id,index) {
            var content = this.detailsSupTabContentList[index].noticeContent||'暂无';
            if (!vm.noice) {
        ...
        financeTabContentBindtap(param, val) {
            console.log("asdasd",param);
            this.financeTabContentListActiveIndex = param;
            this.financeTabContentListActiveValue = val;
            if(param === 1 ){
                /**
                 * 应付
                 */
                layui.table.render({
                    ...
                    where: {
                        carNoAndVinNo: vm.tCarBasic.vinNo,
                        status:-1
                    },
                    page:true,
                    limit:5,
                    ...
                    cols: [[
                        {
                            field: 'paymentNo', align: "center", title: '应付单号',fixed: 'left', templet: function (d) {
                        ...
                        },
                        {
                            field: 'paymentType', align: "center", title: '付款类型', templet: function (d) {
                                if (0 == d.paymentType) {
                                    return d.paymentContent==null?"其他":d.paymentContent;
                ...
                layui.table.render({
                    ...
                    where: {
                        carVinNo: vm.tCarBasic.vinNo
                    },
                    cols: [[
                        {
                            field: 'refundNo', align: "center", title: '退款单号',fixed: 'left', templet: function (d) {
                                return isEmpty(d.refundNo);
                            }
                        },
                        {
                            field: 'leaseType', minWidth: 80, title: '租赁类型', templet: function (d) {
                                return isEmpty(getBillRentTypeStr(d.leaseType));
                        ...
                        },
                        {
                            field: 'refundType', minWidth: 80, title: '退款类型', templet: function (d) {
                                if (d.refundType == 0) {
                                    return d.refundTypeShow==null?'其他':d.refundTypeShow;
        ...
        initEditData: function(carId,businessType,data){
            ...
            $.ajax({
                ...
                success: function (r) {
                    if(!vm.tableData){
                        vm.tableData = r.detailInfo.tCarBasic;
                    }
                    vm.tCarBasic = r.detailInfo.tCarBasic;
                    vm.tCarBasic.itemsName = r.detailInfo.tCarBasic.itemsName || []
                    vm.tCarBasic.fileLst = r.detailInfo.tCarBasic.fileLst||[];
                    if(businessType === 34){
                        vm.tCarBasic.businessTypeStr = '直购-已过户';
                    }
                    vm.carCountDto = r.detailInfo.carCountDto;
                    var carCountDto = r.detailInfo.carCountDto;
                    vm.detailsSupTabContentList = [
                        {
                            name:"基础信息",
                            active_url:"./../../statics/newImages/car/info_1.png",
                            def_url:"./../../statics/newImages/car/info_2.png",
                            noticeContent:"修改车辆信息",
                            title:'车辆编辑',
                            url:'modules/car/tcarbasicedit.html',
                            list:[
                                {
                                    name:"车辆信息",
                                    value:null
                        ...
                        {
                            name:"车辆档案",
                            active_url:"./../../statics/newImages/car/add_2.png",
                            def_url:"./../../statics/newImages/car/add_1.png",
                            noticeContent:"新增车辆信息",
                            list:[
                                {
                                    name:"总数量：",
                                    value:carCountDto.recordCount
                                },
                                {
                                    name:"最新上传：",
                                    value:carCountDto.recordUploadTime
                                }
                            ]
                        },
                        {
                            ...
                            list:[
                                {
                                    name:"总数量：",
                                    value:carCountDto.orderCount
                                },
                                {
                                    name:"已完成总数：",
                                    value:carCountDto.rentFinishCount
                                },
                                {
                                    name:"在租数：",
                                    value:carCountDto.rentCount
                                }
                            ]
                        },
                        {
                            ...
                            list:[
                                {
                                    name:"应收总账款：",
                                    value:carCountDto.receivableAmount
                                },
                                {
                                    name:"应付总账款：",
                                    value:carCountDto.copeWithAmount
                                },
                                {
                                    name:"应退总账款：",
                                    value:carCountDto.alreadyRefund
                                }
                            ]
                        },
                        {
                            ...
                            list:[
                                {
                                    name:"关联客户：",
                                    value:carCountDto.transferCustomerName
                                },
                                {
                                    name:"过户时间：",
                                    value:carCountDto.transferTime
                                }
                            ]
                        },
                        {
                            ...
                            active_url:"./../../statics/newImages/car/add_2.png",
                            def_url:"./../../statics/newImages/car/add_1.png",
                            url:'modules/car/vehicleCarNo.html',
                            noticeContent:"车辆换牌",
                            title:'车辆换牌',
                            list:[
                                {
                                    name:"当前车牌：",
                                    value:carCountDto.newCarNo
                                },
                                {
                                    name:"换牌时间：",
                                    value:carCountDto.vehicleOperateTime
                                }
                            ]
                        },
                        {
                            name:"处置记录",
                            active_url:"./../../statics/newImages/car/cz_1.png",
                            def_url:"./../../statics/newImages/car/cz_2.png",
                            noticeContent:"车辆处置",
                            title:'车辆处置',
                            ...
                            list:[
                                {
                                    name:"处置原因：",
                                    value:carCountDto.disposalReason
                                },
                                {
                                    name:"处置时间：",
                                    value:carCountDto.disposalTime
                                }
                            ]
                        },
                        {
                            ...
                            noticeContent:"新建年检",
                            title:'新建年检',
                            url:'modules/maintenance/inspectionmanageadd.html',
                            list:[
                                {
                                    name:"总次数：",
                                    value:carCountDto.vehicleCount
                                },
                                {
                                    name:carCountDto.vehicleSpareDays == '--' ? '剩余天数：' : carCountDto.vehicleSpareDays>=0 ? '剩余天数：' : '逾期天数：',
                                    value:carCountDto.vehicleSpareDays == '--' ? carCountDto.vehicleSpareDays : carCountDto.vehicleSpareDays>=0 ? carCountDto.vehicleSpareDays : (0-carCountDto.vehicleSpareDays)
                                },
                                {
                                    name:"最新年检：",
                                    value:carCountDto.vehicleMaxDate
                                }
                            ]
                        },
                        {
                            ...
                            noticeContent:"新建保养",
                            title:'新建保养',
                            url:'modules/maintenance/maintenancemanageadd.html',
                            list:[
                                {
                                    name:"总次数：",
                                    value:carCountDto.maintenanceCount
                                },
                                {
                                    name:carCountDto.maintenanceSpareDays == '--' ? '剩余天数：' : carCountDto.maintenanceSpareDays>=0 ? '剩余天数：' : '逾期天数：',
                                    value:carCountDto.maintenanceSpareDays == '--' ? carCountDto.maintenanceSpareDays : carCountDto.maintenanceSpareDays>=0 ? carCountDto.maintenanceSpareDays : (0-carCountDto.maintenanceSpareDays)
                                },
                                {
                                    name:"最新保养：",
                                    value:carCountDto.maintenanceMaxDate
                                }
                            ]
                        },
                        {
                            ...
                            noticeContent:"续保单",
                            title:'续保单',
                            url:'modules/maintenance/insurancemanageadd.html',
                            list:[
                                {
                                    name:"商业险：",
                                    value:carCountDto.spareDaysSy == '--' ? carCountDto.spareDaysSy : carCountDto.spareDaysSy>=0 ? '剩余'+carCountDto.spareDaysSy+'天' : '失效'+(0-carCountDto.spareDaysSy)+'天'
                                },
                                {
                                    name:"交强险：",
                                    value:carCountDto.spareDaysQx == '--' ? carCountDto.spareDaysQx : carCountDto.spareDaysQx>=0 ? '剩余'+carCountDto.spareDaysQx+'天' : '失效'+(0-carCountDto.spareDaysQx)+'天'
                                },
                                {
                                    name:"承运险：",
                                    value:carCountDto.spareDaysCy == '--' ? carCountDto.spareDaysCy : carCountDto.spareDaysCy>=0 ? '剩余'+carCountDto.spareDaysCy+'天' : '失效'+(0-carCountDto.spareDaysCy)+'天'
                                }
                            ]
                        },
                        {
                            name:"违章",
                            active_url:"./../../statics/newImages/car/wz_1.png",
                            def_url:"./../../statics/newImages/car/wz_2.png",
                            noticeContent:"违章查询",
                            url:'modules/car/carillegal.html',
                            title:'违章查询',
                            list:[
                                {
                                    name:"罚款金额：",
                                    value:carCountDto.fineAmount
                                },
                                {
                                    name:"违章总次数：",
                                    value:carCountDto.violationsTotalNumber
                                },
                                {
                                    name:"未处理次数：",
                                    value:carCountDto.unProcessedTimes
                                }
                            ]
                        },
                        {
                            ...
                            noticeContent:"新增出险",
                            title:'新增出险',
                            url:'modules/outinsuranceorder/outinsuranceorderadd.html',

                            list:[
                                {
                                    name:"总次数：",
                                    value:carCountDto.outInsuranceCount
                                },
                                {
                                    name:"最新出险：",
                                    value:carCountDto.outInsuranceMaxDate
                                },
                                {
                                    name:"关联客户：",
                                    value:carCountDto.outInsuranceCustomer
                                }
                            ]
                        },
                        {
                            ...
                            noticeContent:"新增维修",
                            title:'新增维修',
                            url:'modules/carrepairorder/carrepairorderadd.html',

                            list:[
                                {
                                    name:"总次数：",
                                    value:carCountDto.repairCount
                                },
                                {
                                    name:"最新维修：",
                                    value:carCountDto.repairMaxDate
                                }
                            ]
                        },
                        {
                            name:"移库",
                            // active_url:"./../../statics/newImages/car/yk_1.png",
                            // def_url:"./../../statics/newImages/car/yk_2.png",
                            noticeContent:"车辆移库",
                            title:'车辆移库',
                            ...
                            list:[
                                {
                                    name:"总次数：",
                                    value:carCountDto.transfersNumbers
                                },
                                {
                                    name:"出库次数：",
                                    value:carCountDto.outboundTimes
                                },
                                {
                                    name:"当前状态：",
                                    value:carCountDto.transfersStatus
                                }
                            ]
                        },
                        // '基础信息',
         ...
         * @param val
         */
        detailsSupTabContentBindtap(item, index) {
            this.detailsSupTabContentListActiveIndex = index;
            this.detailsSupTabContentListActiveValue = item.name;
            if(index == 3){
                /**
                 * 应收
                 */
                layui.table.render({
                    ...
                    where: {
                        carPlateNo: vm.tCarBasic.vinNo
                    },
                    page:true,
                    limit:5,
                    limits:[5,10,20,30],
                    cols: [[
                        {field:'receivablesNo', minWidth:100, title: '应收单编号',fixed: 'left',align: "center",templet: function (d) {return isEmpty(d.receivablesNo);}},
                        {
                        ...
                        {
                            field: 'customerName', align: "center", title: '客户/渠道名称', templet: function (d) {
                        ...
                        {
                            field: 'collectionTypeShowName', align: "center", title: '收款类型'/*, templet: function (d) {
        ...
        initAllGrid:function(){
            ...
            layui.use(['form', 'element', 'table', 'soulTable'], function () {
                ...
                layui.table.render({
                    ...
                    cols: [
                        [
                            {field: 'hphm', minWidth: 100, title: '车牌号',align: "center",sort: true,templet: function (d) {return isEmpty(d.hphm)}},
                ...
                layui.table.render({
                    ...
                    cols: [
                        [
                            ...
                            {field:'c', minWidth:100, title: '承运险',colspan:6,align:'center'},
                        ],
                        [
                            {field:'applyNoQx', minWidth:100, title: '保单号',align: "center",templet: function (d) {return isEmpty(d.applyNoQx);}},
                            ...
                            {field:'applyNoSy', minWidth:100, title: '保单号',align: "center",templet: function (d) {return isEmpty(d.applyNoSy);}},
                            ...
                            {field:'applyNoCy', minWidth:100, title: '保单号',align: "center",templet: function (d) {return isEmpty(d.applyNoCy);}},
                            {field:'applyTypeCy', minWidth:100, title: '保单时效',align: "center"},
                            {field:'insuranceStartCy', minWidth:100, title: '开始时间',align: "center",templet: function (d) {return isEmpty(d.insuranceStartCy);}},
                            {field:'insuranceEndCy', minWidth:100, title: '结束时间',align: "center",templet: function (d) {return isEmpty(d.insuranceEndCy);}},
                            {field:'insuranceFeeCy', minWidth:100, title: '费用/元',align: "center",templet: function (d) {return isEmpty(d.insuranceFeeCy);}},
                            {field:'carrierCompany', minWidth:100, title: '保险公司名称',align: "center",templet: function (d) {return isEmpty(d.carrierCompany);}},
                ...
                layui.table.render({
                    ...
                    cols: [[
                        ...
                        {field:'orderNo', minWidth:100, title: '车辆订单号',align: "center",templet: function (d) {return isEmpty(d.orderNo);}},
                        {field:'customer', minWidth:100, title: '客户名称',align: "center",templet: function (d) {return isEmpty(d.customer);}},
                        {field:'remark', minWidth:100, title: '备注',align: "center",templet: function (d) {return isEmpty(d.remark);}},
