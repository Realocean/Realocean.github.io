$(function () {
    ...
    layui.form.on('select(carCategorySelect)', function (data) {
        vm.q.carCategory = data.value;
    });
    ...
    layui.upload.render({
        elem: '#imports',
        url: baseURL + 'car/tcarbasic/imports',
        field: 'file',
        auto: true,
        size: 50 * 1024 * 1024,
        accept: 'file', //普通文件
...
var vm = new Vue({
    ...
    methods: {
        ...
        getList(){
            ...
            $.ajax({
                type: "GET",
                url: baseURL + "car/tcarbasic/page",
                // contentType: "application/json",
                data: {
                    'businessType': that.q.businessType,
                    'keyword': that.q.keyword,
                    'deptId': that.q.deptId,
                    'modelId': that.q.modelId,
                    'brandId': that.q.brandId,
                    'seriesId': that.q.seriesId,
                    'depotId': that.q.depotId,
                    'depotName': that.q.depotName,
                    'updateTimeStr': that.q.updateTimeStr,
                    'updateTimeType': that.q.updateTimeType,
                    'vehicleStatus': that.q.vehicleStatus,
                    'sourceType': that.q.sourceType,
                    'carPower':that.q.carPower,
                    'remark':that.q.remark,
                    'deptIdListStr':that.q.deptIdListStr,
                    page: that.q.page,
                    limit: that.q.limit,
                },
                success: function(r){
        ...
        importSuccess: function (map) {
            ...
            var index = layer.confirm(map.message, {
                ...
                if (isdownxls) {
                    var form = $('form#downLoadXlsx');
                    form.find('input[name="datas"]').val(JSON.stringify(map.errDatas));
                    form[0].action = baseURL + 'car/tcarbasic/downxlserr';
                    form.submit();
                }
                layer.close(index);
                vm.reload();
        ...
        initTableCols: function () {
            ...
            if (vm.q.businessType == null) {
                vm.cols = [[
                    ...
                    {title: '操作', width: 70, templet: '#barTpl', fixed: "left", align: "center"},
                    {
                    ...
                    {
                        field: 'vinNo', minWidth: 120, width:200, title: '车架号', align: "center", templet: function (d) {
                            return isEmpty(d.vinNo);
                        }
                    },
                    {
                        field: 'carBrandSeriesModelName',
                        minWidth: 150, width:280,
                        title: '品牌/车系/车型',
                        align: "center",
                        templet: function (d) {
                    ...
                    {field: 'carInspection', minWidth: 120, width:320, title: '年检', align: "center"},
                    {field: 'carInsurance', minWidth: 120, width:580, title: '保险', align: "center"},
                    {
                    ...
                    {
                        field: 'carCategory', minWidth: 120, title: '车辆来源类型', align: "center", templet: function (d) {
                            if(d.carCategory==0){
                                return "自有"
                            }
                            if(d.carCategory==1){
                    ...
                    {field: 'remindMsg', minWidth: 120, width:880, title: '提醒事项', align: "center"},
                ]]
            }
             ...
             * 用车中车辆、预订车辆、展示车、试用车
             */
            if (vm.q.businessType == 3 || vm.q.businessType == 4 || vm.q.businessType == 14 || vm.q.businessType == 15) {
                vm.cols = [[
                    {type: 'radio', fixed: 'left'},
                    ...
                    {
                        field: 'rentType', minWidth: 120, title: '租赁类型', align: "center", templet: function (d) {
                            return isEmpty(d.rentType);
                        }
                    },
                    {
                        field: 'orderNo', minWidth: 120, title: '发车单号', align: "center", templet: function (d) {
                            return isEmpty(d.orderNo);
                        }
                    },
                    {
                        field: 'customer', minWidth: 120, title: '客户名称', align: "center", templet: function (d) {
                            return isEmpty(d.customer);
                        }
                    },
                    {
                        field: 'contact', minWidth: 120, title: '联系电话', align: "center", templet: function (d) {
                            return isEmpty(d.contact);
                        }
                    },
                    {
                        field: 'carOwner', minWidth: 120, title: '车辆所有人', align: "center", templet: function (d) {
                    ...
                    // {field: 'rentNum', minWidth: 120, title: '租期',align: "center",templet: function (d) {return isEmpty(d.rentNum);}},
                    {
                        field: 'rentStartDate', minWidth: 120, title: '租赁开始时间', align: "center", templet: function (d) {
                            return isEmpty(d.rentStartDate);
                        }
                    },
                    {
                        field: 'rentEndDate', minWidth: 120, title: '租赁结束时间', align: "center", templet: function (d) {
                            return isEmpty(d.rentEndDate);
                        }
                    },
                    {
            ...
            if (vm.q.businessType == 5) {
                vm.cols = [[
                    ...
                    {
                        field: 'changeNameDate', minWidth: 120, title: '过户时间', align: "center", templet: function (d) {
                            return isEmpty(d.changeNameDate);
                        }
                    }
                ]]
            }
            ...
            if (vm.q.businessType == 6) {
                vm.cols = [[
                    ...
                    {
                        field: 'useMileAge', minWidth: 120, title: '车辆实时里程数', align: "center", templet: function (d) {
                            return isEmpty(d.useMileAge);
                        }
                    },
                    {
                        field: 'nextMaintenanceSum',
                        minWidth: 120,
                        title: '下次保养公里数',
                        align: "center",
                        templet: function (d) {
                            return isEmpty(d.nextMaintenanceSum);
                        }
                    },
                    {
                        field: 'deptName', minWidth: 120, title: '所属部门', align: "center", templet: function (d) {
            ...
            if (vm.q.businessType == 7) {
                vm.cols = [[
                    ...
                    {
                        field: 'insuranceStatus', minWidth: 120, title: '保险状态', align: "center", templet: function (d) {
                            return isEmpty(d.insuranceStatus);
                        }
                    },
                    {field: 'carInsurance', minWidth: 120, title: '保险', align: "center"},
                    {
            ...
            if (vm.q.businessType == 8) {
                vm.cols = [[
                    ...
                    },
                    {
                        ...
                        align: "center",
                        templet: function (d) {
                            return isEmpty(d.inspectionStatus);
                        }
                    },
                    {
                        field: 'inspectionDate', minWidth: 120, title: '年检时间', align: "center", templet: function (d) {
                            return isEmpty(d.inspectionDate);
                        }
                    },
                    {
                        field: 'inspectionRemainDate',
                        minWidth: 120,
                        title: '年检剩余时间',
                        align: "center",
                        templet: function (d) {
                            return isEmpty(d.inspectionRemainDate);
                        }
                    },
                    {
                        field: 'deptName', minWidth: 120, title: '所属部门', align: "center", templet: function (d) {
            ...
            if (vm.q.businessType == 9) {
                vm.cols = [[
                    ...
                    {
                        field: 'orderNo', minWidth: 120, title: '订单编号', align: "center", templet: function (d) {
                            return isEmpty(d.orderNo);
                        }
                    },
                    {
                    ...
                    {
                        field: 'illegalDate', minWidth: 120, title: '违章时间', align: "center", templet: function (d) {
                            return isEmpty(d.illegalDate);
                        }
                    },
                    {
                        field: 'illegalPoints', minWidth: 120, title: '违章扣分', align: "center", templet: function (d) {
                            return isEmpty(d.illegalPoints);
                        }
                    },
                    {
                        field: 'illegalFine', minWidth: 120, title: '违章罚款/元', align: "center", templet: function (d) {
                            return isEmpty(d.illegalFine);
                        }
                    },
                    {
                        field: 'illegalHandleStatus',
                        minWidth: 120,
                        title: '查询状态',
                        align: "center",
                        templet: function (d) {
                            return isEmpty(d.illegalHandleStatus);
                        }
                    },
                    {
                        field: 'illegalLog', minWidth: 120, title: '违章记录备注', align: "center", templet: function (d) {
                            return isEmpty(d.illegalLog);
                        }
                    },
                    {
                        field: 'illegalHandleDate',
                        minWidth: 120,
                        title: '处理记录时间',
                        align: "center",
                        templet: function (d) {
                            if(d.illegalHandleDate != '' && d.illegalHandleDate != null && d.illegalHandleDate != undefined){
                                if(d.illegalHandleDate == '0001-01-01 00:00:00'){
                                    return '--';
                                }else {
                                    return d.illegalHandleDate;
                                }
                            }else {
                                return isEmpty(d.illegalHandleDate);
                            }
                        }
                    },
                    {
            ...
            if (vm.q.businessType == 11) {
                vm.cols = [[
                    ...
                    },*/
                    {
                        ...
                        align: "center",
                        templet: function (d) {
                            return isEmpty(d.gpsReportDate);
                        }
                    },
                    {
                        field: 'gpsOfflineDays', minWidth: 120, title: '离线时长', align: "center", templet: function (d) {
                            return isEmpty(d.gpsOfflineDays);
                        }
                    },
                    {
                        field: 'deptName', minWidth: 120, title: '所属部门', align: "center", templet: function (d) {
            ...
            if (vm.q.businessType == 12) {
                vm.cols = [[
                    ...
                    {
                        field: 'incompleteInfo',
                        minWidth: 120,
                        title: '信息不全说明',
                        align: "center",
                        templet: function (d) {
                            return isEmpty(d.incompleteInfo);
                        }
                    }
                ]]
            }
            ...
            if (vm.q.businessType == 13) {
                vm.cols = [[
                    ...
                    {field: 'rentToDateMsg', minWidth: 120, title: '租赁到期', align: "center"},
                    {
                        field: 'deptName', minWidth: 120, title: '所属部门', align: "center", templet: function (d) {
                            return isEmpty(d.deptName);
                        }
            ...
            if (vm.q.businessType == 16) {
                vm.cols = [[
                    ...
                    {
                        field: 'replaceCarNo', minWidth: 120, title: '替换车车牌号', align: "center", templet: function (d) {
                            return isEmpty(d.replaceCarNo);
                        }
                    },
                    {
                        field: 'replaceVinNo', minWidth: 120, title: '替换车车架号', align: "center", templet: function (d) {
                            return isEmpty(d.replaceVinNo);
                        }
                    },
                    {
                        field: 'spareCarApplyReason',
                        minWidth: 120,
                        title: '备用车申请原因',
                        align: "center",
                        templet: function (d) {
                            return isEmpty(d.spareCarApplyReason);
                        }
                    },
                    {
                        ...
                        align: "center",
                        templet: function (d) {
                            return isEmpty(d.expectReturnDate);
                        }
                    },
                    {
                        field: 'hasUseDays', minWidth: 120, title: '已使用天数', align: "center", templet: function (d) {
                            return isEmpty(d.hasUseDays);
                        }
                    }
                ]]
            }
            ...
            if (vm.q.businessType == 17) {
                vm.cols = [[
                    ...
                    {
                        field: 'rentType', minWidth: 120, title: '租车类型', align: "center", templet: function (d) {
                            return isEmpty(d.rentType);
                        }
                    },
                    {field: 'carInspection', minWidth: 120, title: '年检', align: "center"},
                    ...
                    {
                        field: 'disputeReason', minWidth: 120, title: '纠纷原因', align: "center", templet: function (d) {
                            return isEmpty(d.disputeReason);
                        }
                    }
                ]]
            }
            ...
            if (vm.q.businessType == 30) {
                vm.cols = [[
                    ...
                    {
                        field: 'faultReason', minWidth: 120, title: '故障原因', align: "center", templet: function (d) {
                            return isEmpty(d.faultReason);
                        }
                    }
                ]]
            }
            ...
            if (vm.q.businessType == 18) {
                vm.cols = [[
                    ...
                    },
                    {
                        ...
                        align: "center",
                        templet: function (d) {
                            return isEmpty(d.repairStartDate);
                        }
                    },
                    {
                        field: 'faultDesc', minWidth: 120, title: '故障描述', align: "center", templet: function (d) {
                            return isEmpty(d.faultDesc);
                        }
                    },
                    {
                        field: 'repairContent', minWidth: 120, title: '维修内容', align: "center", templet: function (d) {
                            return isEmpty(d.repairContent);
                        }
                    },
                    {
                        field: 'serviceName', minWidth: 120, title: '维修厂名称', align: "center", templet: function (d) {
            ...
            if (vm.q.businessType == 19) {
                vm.cols = [[
                    ...
                    {
                        field: 'flowApproveStatus', minWidth: 120, title: '审核状态', align: "center", templet: function (d) {
             ...
             * 融租中-未过户
             */
            if (vm.q.businessType === 33 || vm.q.businessType === 31) {
                vm.cols = [[
                    {type: 'radio', fixed: 'left'},
                    {title: '操作', minWidth: 180, templet: '#barTpl', fixed: "left", align: "center"},
                    {
                    ...
                    {field: 'carInspection', minWidth: 120, title: '年检', align: "center"},
                    {field: 'carInsurance', minWidth: 120, title: '保险', align: "center"},
                    {field: 'orderCarNo', minWidth: 120, title: '车辆订单号', align: "center"},
                    {field: 'lessorName', minWidth: 120, title: '售卖方', align: "center"},
                    {field: 'customer', minWidth: 120, title: '客户名称', align: "center"},
                    {field: 'handleCarTime', minWidth: 120, title: '交车时间', align: "center"},
                    {field: 'transferTime', minWidth: 120, title: '预计过户时间', align: "center"},
                ]]
            }
            /**
             * 融租中-已过户
             */
            if (vm.q.businessType === 34 || vm.q.businessType === 32) {
                vm.cols = [[
                    {type: 'radio', width:60,fixed: 'left'},
                    {title: '操作', minWidth: 120, templet: '#barTpl', fixed: "left", align: "center"},
                    {
                        field: 'carNo', minWidth: 120, title: '车牌号',fixed: "left", align: "center", templet: function (d) {
                            return isEmpty(d.carNo);
                        }
                    ...
                    {field: 'customer', minWidth: 120, title: '客户名称', align: "center"},
                    {field: 'transferTime', minWidth: 120, title: '预计过户时间', align: "center"},
                    {field: 'actualTransferTime', minWidth: 120, title: '实际过户时间', align: "center"},
                ]]
            }
