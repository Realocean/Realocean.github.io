...
var vm = new Vue({
    ...
    created: function(){
        ...
        _this.goodsList = param.goodsList;
        if( param.scOrderActivity != null){
            _this.scOrderActivity = param.scOrderActivity;
        }
        if( param.scOrderServiceInfo != null){
            _this.scOrderServiceInfo = param.scOrderServiceInfo;
        }
    },
    updated: function(){
        layui.form.render();
...
function initTable(table, soulTable) {
    table.render({
        ...
        where: {
            businessNo: vm.scWriteOffLog.id,
            auditType: -1
        },
        cols: [[
