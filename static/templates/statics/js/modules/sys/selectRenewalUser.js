...
var vm = new Vue({
    ...
    methods: {
        ...
        selectUser: function (data) {
            ...
            parent.$("#returnCarPersonnelId").val(personnelId);
            parent.$("#returnCarPersonnelName").val(personnelName);
            parent.vm.companyOrderCar.returnCarPersonnelId = personnelId;
            parent.vm.companyOrderCar.returnCarPersonnelName = personnelName;
