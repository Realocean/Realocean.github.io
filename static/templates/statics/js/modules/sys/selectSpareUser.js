...
var vm = new Vue({
    ...
    methods: {
        ...
        selectUser: function (data) {
            ...
            parent.$("#personnelId").val(personnelId);
            parent.$("#personnelName").val(personnelName);
            parent.vm.deliveryCarCheck.personnelId = personnelId;
            parent.vm.deliveryCarCheck.personnelName = personnelName;
